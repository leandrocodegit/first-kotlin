...
class PurchasesControllerTest {
    ...
    @Test
    fun `test create new purchases invalid age min cliente`(){

        clientResponse = Builds().createClientResponse()
        clientResponse.idade = 15

        every { restClient.requestClient(clientResponse.id) } returns clientResponse
        purchasesRequest.idClient = clientResponse.id
    ...
    @Test
    fun `test create new purchases quantity indisponible`(){

        purchasesRequest.product.qtd = 10000
        var body: String = ObjectMapper().writeValueAsString(purchasesRequest)
    ...
    @Test
    fun `test create new purchases quantity invalid`(){

        purchasesRequest.product.qtd = -10
        var body: String = ObjectMapper().writeValueAsString(purchasesRequest)
    ...
    @Test
    fun `test create new purchases quantity valid`(){

        purchasesRequest.product.qtd = 100
        var body: String = ObjectMapper().writeValueAsString(purchasesRequest)
